		...
		init:function(){
			...
			{console.log("stepper.previous"),e.goPrevious(),KTUtil.scrollTop()})),
					...
					a.push(FormValidation.formValidation(o,
						...
						fileUpload:{validators:{notEmpty:{message:"This field is required"}}},
							thumbnail_img:{validators:{notEmpty:{message:"This field is required"}}},
