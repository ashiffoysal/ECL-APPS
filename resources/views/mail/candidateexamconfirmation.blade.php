...
<div align="left" class="alignment" style="line-height:10px"><img src="https://examcentrelondon.co.uk/uploads/logo/logo_1662996021.png" style="display: block; height: auto; border: 0; width: 205px; max-width: 100%;" width="205"/></div>
</td>
</tr>
</table>
<p style="margin: 0; margin-bottom: 9px;"></p>
<p style="margin: 0; margin-bottom: 9px;"></p>
<p style="margin: 0; margin-bottom: 9px;"></p>
<table border="0" cellpadding="0" cellspacing="0" class="heading_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad" style="width:100%;text-align:center;">
<h1 style="margin: 30px 0px 0px 0px; color: #8a3c90; font-size: 38px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder"></span></h1>
</td>
</tr>
</table>
...
<h1 style="margin: 0; color: #ff0808; font-size: 16px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 400; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder"></span></h1>
</td>
</tr>
<table border="0" cellpadding="0" cellspacing="0" class="heading_block block-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad" style="text-align:center;width:100%;">
<h1 style="margin: 50; color: #ff0808; font-size: 16px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 400; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">IMPORTANT INFORMATION ENCLOSED</span></h1>
</td>
</tr>
</table>
...
<p style="margin: 0; margin-bottom: 16px;">Dear Candidate,</p>
<p style="margin: 0; margin-bottom: 16px;">{{ $user['details'] }}</p>
<p style="margin: 0;"> </p>
</div>
</td>
</tr>
...
<p style="margin: 0; margin-bottom: 7px;"><strong>Exam : {{ $user['exam_type'] }}</strong></p>
<p style="margin: 0; margin-bottom: 7px;"><strong>Subject: {{ $user['subject'] }}</strong></p>
<p style="margin: 0; margin-bottom: 7px;"><strong>Exam Date & Time: {{ $user['exam_date'] }}, {{ $user['exam_time'] }}</strong></p>
<p style="margin: 0; margin-bottom: 7px;"><strong>Exam Venue: {{ $user['exam_branch'] }}</strong></p>
...
<td class="pad">
<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
<p style="margin: 0; margin-bottom: 16px;"><strong>Requirments</strong>:{{ $user['requirments'] }}</p>
<p style="margin: 0;"> </p>
</div>
</td>
</tr>
...
<td class="pad">
<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
<p style="margin: 0; margin-bottom: 16px;"><strong>Rescheduling</strong>: {{ $user['rescheduling'] }}</p>
<p style="margin: 0;"> </p>
</div>
</td>
</tr>
...
<p style="margin: 0; margin-bottom: 8px;"><strong>Our Bank Details</strong>:</p>
<p style="margin: 0; margin-bottom: 8px;">Edu Service Limited</p>
<p style="margin: 0; margin-bottom: 8px;">Sort Code: 04-06-05</p>
<p style="margin: 0; margin-bottom: 8px;">Account Number: 18901601</p>
<p style="margin: 0; margin-bottom: 8px;">Reference: Your name</p>
<p style="margin: 0;"> </p>
</div>
</td>
</tr>
...
<td class="pad">
<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
<p style="margin: 0; margin-bottom: 9px;"><strong>Cancellation</strong>: Not Allowed.</p>


<p style="margin: 0; margin-bottom: 9px;"> </p>
<p style="margin: 0; margin-bottom: 9px;">Kind regards</p>
<p style="margin: 0; margin-bottom: 9px;">M Rahman, Exam Administrator</p>
<p style="margin: 0;">Exam Centre London \ Merit Tutors</p>
</div>
</td>
</tr>
</table>
