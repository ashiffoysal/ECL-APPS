        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Contact Message Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Contact</span>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%">
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td><a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->name  }}</a></td>
                                            <td><a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->phone  }}</a></td>
                                            <td><a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->email  }}</a></td>
                                            <td><a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->subject  }}</a></td>
                                            <td>
                                                @if($data->is_seen==0)
                                            ...
                                            <td class="text-end">
                                                <a href="{{url('/admin/contactmessage/view/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" >
                                                <i class="fas fa-eye blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('/admin/contactmessage/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
