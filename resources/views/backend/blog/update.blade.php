        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Blog</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                                ...
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder="Blog Title" value="{{$edit->title}}">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    ...
                                                    <select name="category" id="category_id" class="form-control form-control-solid">
                                                        ...
                                                        <option value="{{$categoty->id}}" @if($edit->category_id==$categoty->id) selected @endif>{{ $categoty->name }}</option>
                                                        @endforeach         
                                                    </select>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="tags" id="tags" data-role="tagsinput" class="form-control form-control-solid tags" type="text" placeholder="Tag" value="{{ $edit->tag }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea id="summernote" st class="form-control form-control-solid" name="description" placeholder="Product Description" >{{ $edit->description }}</textarea>
                                                </div>
                                            </div>
                                            @error('description')
                                                ...
                                                <div id="editimage" class="col-xl-12 col-md-12 col-sm-12 col-xs-12 spartan_item_wrapper" data-spartanindexrow="0" style="margin-bottom : 20px; ">
                                                    <div style="position: relative;">
                                                        ...
                                                        <label class="file_upload" style="width: 100%; height: 450px; border: 2px dashed #ddd; border-radius: 3px; cursor: pointer; text-align: center; overflow: hidden; padding: 5px; margin-top: 5px; margin-bottom : 5px; position : relative; display: flex; align-items: center; margin: auto; justify-content: center; flex-direction: column;">
                                                            ...
                                                            <img style="width: 100%; margin: 0px auto; vertical-align: middle; display: ;" data-spartanindexi="0" src="{{asset('uploads/'.$edit->image)}}">
