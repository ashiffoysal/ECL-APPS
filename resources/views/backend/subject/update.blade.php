        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Subject</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="card">
                <form action="{{ url('admin/subject/update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                                ...
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   ...
                                                   <select name="exam_type" class="form-select form-select-solid" >
                                                       <option value="GCSE" @if($edit->exam_type=='GCSE') selected  @endif>GCSE</option>
                                                       <option value="A Level" @if($edit->exam_type=='A Level') selected  @endif>A Level</option>
                                                       
                                                       <option value="AS Level" @if($edit->exam_type=='AS Level') selected  @endif>AS Level</option>
                                                      <option value="IGCSE" @if($edit->exam_type=='IGCSE') selected  @endif>IGCSE</option>


                                                       <option value="AAT" @if($edit->exam_type=='AAT') selected  @endif>AAT</option>
                                                       <option value="FUNCTIONAL SKILLS" @if($edit->exam_type=='FUNCTIONAL SKILLS') selected  @endif>FUNCTIONAL SKILLS</option>
                                                       <option value="ACCA" @if($edit->exam_type=='ACCA') selected  @endif>ACCA</option>
                                                   </select>
                                                </div>
                                                @error('exam_type')
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <select name="exam_board" class="form-select form-select-solid" >
                                                       <option value="none" @if($edit->exam_board=='none') selected @endif>None</option>
                                                       <option value="Edexcel" @if($edit->exam_board=='Edexcel') selected @endif>Edexcel</option>
                                                       <option value="AQA" @if($edit->exam_board=='AQA') selected @endif>AQA</option>
                                                       <option value="OCR" @if($edit->exam_board=='OCR') selected @endif>OCR</option>
                                                       <option value="Cambridge CIE" @if($edit->exam_board=='Cambridge CIE') selected @endif>Cambridge(CIE)</option>
                                                       <option value="WJEC" @if($edit->exam_board=='WJEC') selected @endif>WJEC</option>
                                                       <option value="Foundation In Accountancy" @if($edit->exam_board=='Foundation In Accountancy') selected @endif>Foundation In Accountancy</option>
                                                       <option value="Applied Knowledge" @if($edit->exam_board=='Applied Knowledge') selected @endif>Applied Knowledge</option>
                                                       <option value="Applied Skills" @if($edit->exam_board=='Applied Skills') selected @endif>Applied Skills</option>
                                                   </select>
                                                </div>
                                                @error('exam_board')
                                                <div style="color:red">{{ $message }}</div>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="subject_name" placeholder="Enter Title" value="{{ $edit->subject_name }}">
                                                    <input  type="hidden" name="id" value="{{ $edit->id }}">
                                                </div>
                                                @error('subject_name')
                                                <div style="color:red">{{ $message }}</div>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="unit_code" placeholder="Unit Code" value="{{ $edit->unit_code }}">
                                                </div>
                                                @error('unit_code')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="exam_fees" placeholder="Enter Exam Fees" value="{{ $edit->exam_fees }}">
                                                </div>
                                                @error('exam_fees')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                          ...
                                          <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="late_fees" placeholder="Enter Late Fees" value="{{ $edit->late_fees }}">
                                                </div>
                                                @error('late_fees')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                          ...
                                          <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="high_late_fees" placeholder="Enter High Late Fees" value="{{ $edit->high_late_fees }}">
                                                </div>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="d-flex fw-bold h-100">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="practical" type="radio" value="1" id="email" @if($edit->is_practical == 1) checked @endif >
                                                        <label class="form-check-label ms-3" for="email">With Practical</label>
                                                    </div>
                                                    <!--end::Checkbox-->
                                                    <!--begin::Checkbox-->
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" name="practical"  type="radio" value="0" id="phone" @if($edit->is_practical == 0) checked @endif >
                                         ...
                                         <div class="row mb-10" id="dvPinNo" @if($edit->is_practical == 1) @else style="display:none;" @endif  >
                                            <label class="col-lg-3 col-form-label text-lg-end">Practical Fees:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="practical_fees" placeholder="Enter Practical Fees" value="{{ $edit->practical_fees }}">
                                                </div>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-xl-9">
                                                <div class="d-flex fw-bold h-100">
                                                      <div class="form-check form-check-custom form-check-solid me-9">
                                                        <input class="form-check-input" name="has_option_code"  type="radio" value="0" id="no_has_option_code" @if($edit->has_option_code==0) checked @endif>
                                                        <label class="form-check-label ms-3" for="no_has_option_code">No</label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid ">
                                                        <input class="form-check-input" name="has_option_code" type="radio" value="1" id="yes_has_option_code"  @if($edit->has_option_code==1) checked @endif>
                                        ...
                                        <div id="main_section" @if($edit->has_option_code==0) style="display:none; @endif ">
                                            @foreach(json_decode($edit->option_code_details) as $main)
                                            <div class="row mb-10">
                                                <label class="col-md-3 col-form-label text-lg-end">Option Code:<span class="required"></span></label>
                                                <div class="col-md-3">
                                                    <!--begin::Wrapper-->
                                                    <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                        <input class="form-control form-control-solid" type="text" name="option_code[]" placeholder="Enter Option Code" value="{{ $main->option_code }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <!--begin::Wrapper-->
                                                    <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                        <input class="form-control form-control-solid" type="text" name="description[]" placeholder="Enter Description"value="{{ $main->description }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-1"><a onclick="deleterow(this)" style="color:red; cursor:pointer;"><i class="fa fa-trash" style="color: #dd0505;"></i></a></div>
                                            </div>
                                            @endforeach
