						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="{{url('/admin')}}" class="d-lg-none">
									...
									<img alt="a" src="{{asset('uploads/adminimage/'.$companyInformation->logo)}}" style="height:50px !important;" />
                                    @else
                                    <img alt="Logao" src="{{asset('backend')}}/assets/media/logos/logo-compact.svg" style="height:50px !important;" />
                                    @endif
								</a>
							</div>
							<!--end::Mobile logo-->
								...
								<div class="d-flex align-items-stretch" id="kt_header_nav">
									...
									<div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											...
											@php
											$contactmessage=App\Models\ContactMesssage::where('is_seen',0)->count();
											@endphp
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{route('admin.contactmessage.index')}}">
													<span class="menu-title">Contact Message</span><span class="badge badge-success">{{ $contactmessage }}</span>
												</a>
											</div>
											@endif
										
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('/admin/student/list')}}">
													<span class="menu-title">Student List</span> 
													<!-- <span class="badge badge-success"></span> -->
												</a>
											</div>
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('admin/cupon/create')}}">
											...
											@php
											$ucascount=App\Models\UcasRequest::where('is_seen',0)->count();
											@endphp
										
										<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('/admin/ucas/index')}}">
													<span class="menu-title" style="color:#fff">Ucas Request </span> <span class="badge badge-success">{{ $ucascount }}</span>
												</a>
											</div>

											<div class="menu-item me-lg-1">
												<a class="menu-link" target="__blank" href="{{url('/')}}">
													<span class="menu-title  badge badge-success" style="color:#fff">Live Site</span>
												</a>
											</div>
											
												<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{url('admin/all-confirmation/bydate')}}">
													<span class="menu-title  badge badge-primary" style="color:#fff">Exam Date & Time</span>
												</a>
											</div>
										@if(Auth::user()->create_exam_booking==1)
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title badge badge-warning" style="color:#fff">Create Exam Booking</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													<div class="menu-item">
														<a class="menu-link py-3" href="{{route('admin.exambooking.create')}}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">GCSE Exam</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('admin/exam-booking-igcse/create') }}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">IGCSE</span>
														</a>
													</div>
													<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('admin/exam-booking-alevel/create') }}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
													...
													<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('admin/exam-booking-aat/create') }}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">AAT</span>
														</a>
													</div>
														<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('admin/exam-booking-acca/create') }}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
															<span class="menu-title">ACCA</span>
														</a>
													</div>
														<div class="menu-item">
														<a class="menu-link py-3" href="{{ url('admin/exam-booking-functionalskills/create') }}">
															<span class="menu-icon">
																<i class="bi bi-grid fs-3"></i>
															</span>
