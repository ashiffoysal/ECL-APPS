                            ...
                            <div class="row">
                                <div class="quote-item">
                                    <div class="asif-tutor col-lg-12 row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Phone:</label><span>@if($data->tutor_is_approve==1) {{$data->Student->phone }} @else Hidden @endif</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" style="font-weight:500">Email:</label><span>@if($data->tutor_is_approve==1) {{$data->Student->email }} @else Hidden @endif</span>
                                        </div>
                                        <div class="col-md-6">
