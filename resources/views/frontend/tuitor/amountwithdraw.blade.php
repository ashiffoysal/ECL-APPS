                                        ...
                                        <div class="row">
                                            <div class="quote-item">
                                                <div class="asif-tutor col-lg-12 row">
                                                    <div class="content">
                                                        <h6>Account Balance: {{ $dabit_amount - $credit_amount }} £</h6>
                                                    </div>
                                            ...
                                            <div class="quote-item">
                                                <div class="asif-tutor col-lg-12 row">
                                                    <div class="content">
                                                        ...
                                                        <p style="color:red">Withdraw any amount starting from £50 today to your bank account below: </p>
                                                    </div>
                                                    ...
                                                    <form action="{{ url('tutor/withdraw') }}" method="post">
                                                        @csrf
                                                         ...
                                                         <div class="form-group">
                                                          ...
                                                          <div class="form-group">
                                                            <label for="exampleFormControlTextarea1">Account Details</label>
                                                            <textarea class="form-control" id="exampleFormControlTextarea1" name="account_details" rows="3"></textarea>
                                                          </div>
                                                          <div class="form-group">
