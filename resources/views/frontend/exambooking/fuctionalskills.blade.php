  ...
  .breadcrumb-section ul {
    ...
    <section class="breadcrumb-section text-center">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>FUNCTIONAL SKILLS EXAM BOOKING</h2>
                    <ul>
                        <li><a href="">PLEASE CALL OR E-MAIL US IF YOU NEED ANY HELP WITH THE FORM<br>

                        PHONE: 02086162526 OR
                        <br>
                        E-MAIL: lNFO@EXAMCENTRELONDON.CO.UK</a></li>
                ...
                <div class="card" style="border-radius:55px">
                  ...
                  <div class="card-body">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
                      ...
                      <!--end::Nav-->
                      <!--begin::Form-->
                      <form class="mx-auto mw-1000px w-100 pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form" action="{{ url('/exam-booking-functional-skills') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="fv-row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <input type="hidden" id="main_exam_type" name="main_exam_type" value="Functional Skills"/>
                                  <!--end::Input-->
                                </div>
                               ...
                               {{--
                                  <div class="col-lg-12 mt-3">
                                    ...
                                    <label for="recent_photo" class="form-label">Recent photo </label>
                                 
                                       
                                        <div id="thumbnail_img"></div>
                                    <br>
                                    <span style="font-size: 12px;">(Accepted file types: jpg, jpeg, png, Max. file size: 10 MB.)</span><br>
                                ...
                                <div class="col-lg-12 mt-3">
                                  <label for="PHOTO_ID" class="form-label">Photo ID *</label>
                                   ...
                                   <span style="font-size: 12px;">(Accepted file types: jpg, jpeg, png,Max. file size:  150 kb.)</span><br>
                                   <span style="color:red">This field is required</span>
                   ...
                   <div data-kt-stepper-element="content">
                          ...
                          <div class="w-100">
                            ...
                            <div class="pb-10 pb-lg-15">
                             ...
                             <div class="mb-10 fv-row row" onclick="newalert()">
                                ...
                                <div class="col-md-3" style="margin: 0px 5px;">
                                        ...
                                        <div class="mb-0 fv-row">
                                          ...
                                          Choose the dates<span style="color: red;">*</span>
                                          </label>
                                          <!--end::Label-->
                                          <!--begin::Options-->
                                          <div class="mb-0 row">
                                          
                                          <input type="date" id="exam_date_0" onchange="exam_date(this)" name="exam_date[]" class="form-control form-control-lg form-control-solid exam_date">
                                          <span class="warring_message_0"></span>
                                 ...
                                 <div class="col-md-2">
                                  ...
                                  <div class="col-md-3">
                                    <!--begin::Label-->
                                  <label class="form-label mb-3">Exam Type <span style="color: red;">*</span></label>
                                  <!--end::Label-->
                                  <!--begin::Input-->
                            ...
                            <div class="mb-10 fv-row row">
                              ...
                              <div class="mb-10 fv-row row">
                                <div class="col-lg-12 mt-2">
                                  ...
                                  <div class="form-check" style="margin:10px 0px">
                                    <input onchange="insertmybooking()" class="form-check-input" id="Learning_via" type="radio"  name="type_of_learner"  value="Learning via, or registered with, one of our Partners" @if($maindata) @if($maindata->type_of_learner=='Learning via, or registered with, one of our Partners') checked="checked" @endif @else  checked="checked"  @endif/>
                                ...
                                <div class="col-lg-12 mt-2">
                                  <label for="" class="d-flex align-items-center form-label">Are you caring forward your practical endorsement /course work/ spoken/ or any other assessment?</label>
                                  <div class="form-check" style="margin:10px 0px">
