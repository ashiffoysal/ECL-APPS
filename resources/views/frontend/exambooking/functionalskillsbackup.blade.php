                ...
                <div class="card" style="border-radius:55px">
                  ...
                  <div class="card-body">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
                      ...
                      <!--end::Nav-->
                      <!--begin::Form-->
                      <form class="mx-auto mw-1000px w-100 pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form" action="{{ url('/exam-booking-fuctional-skills') }}" method="post">
                          ...
                          <div class="w-100">
                            ...
                            <div class="pb-10 pb-lg-15">
                              ...
                              <div class="text-gray-400 fw-bold fs-6">
                                Option Code Information <a data-toggle="modal" data-target="#exampleModalLong" href="#">Click</a>
                                ...
                                <div class="col-md-2">
                                 ...
                                 <div class="col-md-2">
                                  ...
                                  <select name="type[]" id="type_0"  class="form-select form-select-lg form-select-solid type">
                                    ...
                                    <option value="Level 2 Resources">Level 2 Resources</option>
                            ...
                            <div class="mb-10 fv-row row">
                             ...
                             <div class="col-lg-12 mt-2">
                                <div class="mb-0 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center form-label mb-5">What time would you like to start your exam?
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Options-->
                                    <div class="mb-0 row">
                            ...
                            Choose the dates you would like to book your exam for*
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Options-->
                                    <div class="mb-0 row">
                        ...
                        <div data-kt-stepper-element="content">
                          ...
                          <div class="w-100">
                           ...
                           <div class="col-lg-12 mt-2">
                            ...
                            <div class="col-lg-12 mt-2">
                              <label for="UCI" class="form-label">Signature</label><br>
                        ...
                        <div data-kt-stepper-element="content">
                          ...
                          <div class="w-100">
                            ...
                            <div class="pb-8 pb-lg-10">
                              ...
                              <a href="{{ url('/') }}" class="link-primary fw-bolder">Help page</a>.</div>
                              <!--end::Notice-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Body-->
