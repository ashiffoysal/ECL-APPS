                ...
                <div class="card" style="border-radius:55px">
                  ...
                  <div class="card-body">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
                      ...
                      <!--end::Nav-->
                      <!--begin::Form-->
                      <form class="mx-auto mw-1000px w-100 pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form" action="{{ url('/exam-booking-gcse') }}" method="post" enctype="multipart/form-data">
                        <!--begin::Step 1-->
                            ...
                            <div class="fv-row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <input type="hidden" id="main_exam_type" name="main_exam_type" value="GCSE"/>
                                  <!--end::Input-->
                                </div>
                                ...
                                <div class="col-lg-12 mt-2" id="has_a_candidate_section" @if($maindata) @if($maindata->has_a_candidate=='yes') @else style="display:none" @endif @else style="display:none" @endif > 
                                  ...
                                  <span>This will be on Previous Timetables and Results Information</span>
                                    <input type="text" onchange="insertmybooking()"  name="has_a_candidate_number" id="has_a_candidate_number" class="form-control form-control-lg form-control-solid" aria-describedby="passwordHelpBlock" value="@if($maindata){{$maindata->has_a_candidate_number }}@endif">
                        ...
                        <div class="mb-10 fv-row row">
                              <div class="col-lg-12 mt-2">
                                ...
                                <div class="col-lg-12 mt-2">
                                  ...
                                  <div class="form-check" style="margin:10px 0px">
                                      <input onchange="insertmybooking()" class="form-check-input" id="retaking_exams_yes" type="radio" name="retaking_exams" value="yes" @if($maindata) @if($maindata->retaking_exams=='yes') checked="checked" @endif  @else checked="checked" @endif/>
                                    <label class="form-check-label" for="Private_Candidate">
                                     Yes
                                    </label>
                                  </div>
                              ...
                              <div class="col-lg-12 mt-2" id="caring_forwad_section" @if($maindata) @if($maindata->caring_forwad=='yes') @else style="display:none" @endif @else style="display:none" @endif >
                                <label for=""  class="form-label">Please Specify the details including exam board & grade*
                                </label>
...
proceed to make the payment</h2>
                              <!--end::Title-->
                              <!--begin::Notice-->
                              <!-- <div class="text-gray-400 fw-bold fs-6">If you need more info, please click
             ...
             $.ajax({
                 ...
                 success:function(data) {
                      ...
                      if(seris=='November 2023'){
                        ...
                        if(seris=='January 2023'){
                          $('#fees_demo_'+mainid).val(data.late_fees);
                          $('#fees_'+mainid).val(data.late_fees);
                          var amou=parseInt(data.late_fees);
                        }
                         if(seris=='June 2023'){
                          $('#fees_demo_'+mainid).val(data.exam_fees);
                          $('#fees_'+mainid).val(data.exam_fees);
                 ...
                 success:function(data) {
                    ...
                    $('#unit_code_'+mainid).val(data.unit_code);
                      ...
                      if(seris=='November 2023'){
                        ...
                        if(seris=='January 2023'){
                          $('#fees_demo_'+mainid).val(data.high_late_fees);
                          $('#fees_'+mainid).val(data.high_late_fees);
                          var amou=parseInt(data.high_late_fees);
                        }
                         if(seris=='June 2023'){
                          $('#fees_demo_'+mainid).val(data.exam_fees);
                          $('#fees_'+mainid).val(data.exam_fees);
...
<div class="modal fade" id="exampleModalLongss" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        @php
        $alloptioncode=App\Models\Subject::where('exam_type','GCSE')->where('has_option_code',1)->orderBy('id','DESC')->get();
        @endphp
        <table class="table">
          <thead>
            <tr>
...
<script>
  (function() {
  function Init() {
    var fileSelect = document.getElementById('file-upload-two'),
      fileDrag = document.getElementById('file-drag-two'),
      submitButton = document.getElementById('submit-button-two');
  ...
  function output(msg) {
    var m = document.getElementById('messages-two');
    m.innerHTML = msg;
  }
