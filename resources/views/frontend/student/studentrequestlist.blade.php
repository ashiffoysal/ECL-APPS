                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{ ++$key }}</th>
                                        <td>
                                            <span style="font-size:12px">Start Date: {{$data->pick_date}}</span><br>
                                            <span style="font-size:12px">End Date: {{$data->pick_date}}</span>
                                        </td>
                                        ...
                                        <td>@if($data->tutor_is_approve==0) <span style="color:red">Tutor Not Accept</span> @elseif($data->tutor_is_approve==1) <span  style="color:green"> Tutor Accept  </span> @else <span  style="color:Blue"> Tutor Reject(Reason: {{ $data->tutor_reject_reson }})  </span>  @endif</td>
                                        <td>
                                            <a href="{{ url('/student/tutorrequestlist/update/'.$data->id) }}"><i class="fa fa-pencil"></i></a>
                                            <a id="delete" href="{{ url('/student/tutorrequestlist/delete/'.$data->id) }}"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
