              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    @php
                    $count=App\Models\ExamRequest::where('user_id',Auth::user()->id)->where('is_completed_from',1)->where('is_deleted',1)->count();
                    @endphp
               ...
               <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    @php
                    $maincount=App\Models\ExamRequest::where('user_id',Auth::user()->id)->where('is_paid',0)->where('is_completed_from',1)->where('is_deleted',1)->count();
                    @endphp
