                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->subject }}</td>
                                        <td>@if($data->tutor_is_approve==0)Pending @elseif($data->tutor_is_approve==1)Approve @elseif($data->tutor_is_approve==2) Reject @endif</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            @if($data->due_amount !=null)
                                             <a href="{{ url('/student/due_amount/paid/'.$data->order_id) }}" data-toggle="tooltip" data-placement="top" title="Please Pay Due Amount"><i class="fa fa-money"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
