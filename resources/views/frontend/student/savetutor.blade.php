  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          ...
          <div class="panel-body bio-graph-info">
              <h1 style="margin-top:20px">Saved Tutor</h1>
              <div class="row">
                 <!--  -->
                    ...
                    <div class="albums">
                        ...
                        <div class="album">
                            ...
                            <div class="album__details">
                                <h2>{{$tutor->name}}</h2>
                                <p class="album__artist">@if($tutor->for_online_tutor==1)  ONLINE TUTOR @endif @if($tutor->for_home_tutor==1)  HOMETUTOR @endif </p>
                                <span style="color:black">{{ $tutor->expected_hourly_rate}} £ per Hour</span>
                                <p class="album__desc">{{  $tutor->headline_for_tutor }}</p>
                                <a href="{{ url('/tutor-find/details/'.$tutor->id) }}"> <i class="fa fa-eye"></i></a>
