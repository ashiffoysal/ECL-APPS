             ...
             <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleSelectGender">Date Of Birth</label>
                        <input type="date" name="date_of_birth" class="form-control" placeholder="Enter Student Date Of Birth" value="{{ Auth::user()->date_of_birth }}">
                            @error('date_of_birth')
                            <div style="color: red">{{ $message }}</div>
                            @enderror
                      </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="exampleTextarea1">Address line two</label>
