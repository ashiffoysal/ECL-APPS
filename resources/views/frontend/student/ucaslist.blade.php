            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">UCAS Exam booking list 
                    </p>
                        ...
                        <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             @if($data->is_paid_verify==0)
                                            <a class="badge badge-gradient-primary" href="{{ url('/make-payment/ucas-booking/'.$data->ucas_booking_id) }}">Pay</a> 
                                            @endif
                                            <a class="badge badge-gradient-success" href="{{ url('ucas-exam-booking-details/'.$data->ucas_booking_id) }}">Details</a>
                                            @if($data->is_paid_verify==0)
                                            <a id="delete" class="badge badge-gradient-danger" href="{{ url('ucas-exam-booking/delete/main/'.$data->id) }}">Delete</a>
                                            @endif
                                            
                                              <a class="badge badge-gradient-primary" href="{{ url('ucas-exam-booking/details/invoice-download/'.$data->ucas_booking_id) }}">Invoice Download</a>
